...
import {BellIcon, ChartBarIcon, HomeIcon, MapIcon, MenuAlt2Icon, XIcon} from '@heroicons/react/outline'
                                ...
                                <nav className="px-2 space-y-1">
                                    {navigation.map((item) => (
                                        ...
                                        >
                                            <item.icon
                                                className={classNames(
                                                    current(item) ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300',
                                                    'mr-4 h-6 w-6'
                                                )}
                                                aria-hidden="true"
                                            />
                ...
                <div className="flex flex-col w-64">
                    ...
                    <div className="flex flex-col h-0 flex-1">
                        <div className="flex items-center h-16 flex-shrink-0 px-4 bg-gray-900">
                            <h1 className="text-gray-100 text-xl font-bold">Strava Heatmap</h1>
                        </div>
